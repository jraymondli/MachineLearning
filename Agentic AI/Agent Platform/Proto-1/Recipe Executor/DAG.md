...
1. **Structural checks**: Node existence, unique IDs, cycle detection
2. **Type checking**: Edge compatibility verification
3. **Arity validation**: Port cardinality requirements
4. **Config validation**: Required args and enum membership
5. **Field-flow analysis**: Hit field propagation and requirements
...
The system defines 12+ primitives with full contracts:
